  ...
  <section class="flex signup-section">
    ...
    <h2>Let’s get started</h2>
        ...
        <div>
          ...
          <label> <input class="form-checkbox" type="checkbox"> I agree to the <button class="button-link">terms of service</button>  and <button class="button-link">privacy policy.</button></label>
          <label> <input class="form-checkbox" type="checkbox"> Yes, send me deals, discounts and updates!</label>
